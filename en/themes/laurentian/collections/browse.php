...
<div id="browseCollectionsSecondary">
	...
	<p><?php echo __('Collections are a quick way to get an overview of the items in each exhibit. The details of each item is found within the exhibit. However, citations for each item can be found here or by browsing the items.'); ?></p>
