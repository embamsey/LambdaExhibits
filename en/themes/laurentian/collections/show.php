...
<div id="viewCollectionprimary">
    ...
    <div id="collection-items">
        <h2><?php echo __('Top items in the %s Collection', collection('Name')); ?></h2>
	...
	<p><?php echo ("");?></p>
	<p style="font-size:2em;" class="view-items-link"><?php echo link_to_browse_items(__('View all the items in %s', collection('Name')), array('collection' => collection('id'))); ?></p>
